...
class RobotRunner(BaseRunner):
    ...
    def get_action(self, policy: BasePolicy, observaton=None) -> bool:
        action, _ = self.get_action_with_meta(policy, observaton=observaton)
        return action

    def get_action_with_meta(self, policy: BasePolicy, observaton=None):
